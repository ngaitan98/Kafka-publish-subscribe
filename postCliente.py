...
while i != 0:
    ...
    r = requests.post("http://172.24.41.208:8082/nidoo/clienteslist", data={'id':id, 'nombre' : nombre, 'documento' : documento, 'usuario' : usuario, 'contrasenia': contrasenia, 'edad': edad})
    i-=1
