...
while j != 0:
    r = requests.post("http://172.24.41.208:8082/nidoo/transaccionlist", data={'id': j, 'id_reserva': j, 'costo': round(uniform(12000,34000), 2),'tipo' : tipos[int(round(uniform(0,len(tipos) - 1),0))]})
