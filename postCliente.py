...
while i != 0:
    ...
    r = requests.post("http://172.24.41.208:8082/nidoo/clientelist", data={'id':1, 'nombre' : 'Nicolas Gaitan', 'documento' : '1018505086', 'usuario' : 'n.gaitan', 'contrasenia': 'Greenday1', 'edad': 20})
    i-=1
    print(r.status_code)
